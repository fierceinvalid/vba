...
End If
 ...
 Dim MyArray(1 To 6) As Variant
        ...
        MyArray(1) = "1 Details"
        MyArray(2) = "2 Documentation"
        MyArray(3) = "3 Business Member Financials"
        MyArray(4) = "4 Guarantor Financials"
        MyArray(5) = "5 Collateral"
        MyArray(6) = "6 Miscellaneous"
...
'--Main Folder------
    ...
    For Each SubFolder In Folder.subfolders
        ...
        For i = 1 To UBound(MyArray)
             If oldFolder = MyArray(i) Then
             'do nothing
             ElseIf Left(Trim(oldFolder), 1) = 1 Then
             answer = MsgBox("CHANGE FOLDER NAME OF:" & vbNewLine & vbNewLine & oldFolder & vbNewLine & vbNewLine & "TO:" & vbNewLine & vbNewLine & MyArray(i), vbYesNo + vbQuestion, "Empty Sheet")
                If answer = vbYes Then
                    newFolder = Replace(oldFolder, oldFolder, MyArray(i))
